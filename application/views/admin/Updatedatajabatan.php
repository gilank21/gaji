    ...
    <div class="card-body">
        ...
        <form method="POST" action="<?php echo base_url('admin/Datajabatan/update_data_aksi')?>">
            <div class="form-group">
                ...
                <?php echo form_error(
                    'nama_jabatan','<div class="text-small text-danger"></div>') 
            ...
            <div class="form-group">
                ...
                <?php echo form_error(
                    'gaji_pokok','<div class="text-small text-danger"></div>') 
            ...
            <div class="form-group">
                ...
                <?php echo form_error(
                    'tj_transport','<div class="text-small text-danger"></div>') 
            ...
            <div class="form-group">
                ...
                <?php echo form_error(
                    'uang_makan','<div class="text-small text-danger"></div>') 
